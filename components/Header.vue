...
<template>
  <header class="sticky top-0 flex h-16 items-center gap-4 border-b px-4 md:px-6 bg-transparent z-50"
    :class="{ 'bg-white': isScrolled }" @scroll="handleScroll">
    <nav
            ...
            <NavigationMenuItem>
              ...
              <NavigationMenuContent>
                <div class="grid gap-3 p-6 md:w-[700px] lg:w-[1200px] lg:grid-cols-3">
                  ...
                  <div class="border-e p-2">
                    ...
                    <div>
                      ...
                      <NavigationMenuLink as-child>
                        <a href="/"
                          class="flex gap-4 items-center select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground">
                          <img src="@/assets/images/channel-partner.svg" alt="" class="h-12 " />
                          <div class="flex flex-col gap-2">
                      ...
                      <NavigationMenuLink as-child>
                        <a href="/"
                          class="flex gap-4 items-center select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground">
                          <img src="@/assets/images/virtual-tour.svg" alt="" class="h-12 opacity-70" />
                          <div class="flex flex-col gap-2">
                      ...
                      <NavigationMenuLink as-child>
                        <a href="/"
                          class="flex gap-4 items-center select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground">
                          <img src="@/assets/images/discover.svg" alt="" class="h-12 opacity-70" />
                          <div class="flex flex-col gap-2">
                  ...
                  <div class="p-2">
                    <h2 class="mb-3 text-gray-500">Lead Protection for Brokers</h2>
                    <div>
                      <NavigationMenuLink as-child>
                        <a href="/"
                          class="flex gap-4 items-center select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground">
                          <img src="@/assets/images/lead-hub.svg" alt="" class="h-12 opacity-70" />
                          <div class="flex flex-col gap-2">
                      ...
                      <NavigationMenuLink as-child>
                        <a href="/"
                          class="flex gap-4 items-center select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground">
                          <img src="@/assets/images/channel-collect.svg" alt="" class="h-12 opacity-70" />
                          <div class="flex flex-col gap-2">
                  ...
                  <div class="">
                    <NavigationMenuLink as-child>
                      <a href="/"
                        ...
                        <img src="@/assets/images/custom-software.gif" class="max-w-52 mx-auto">
                        <div class="mb-2 mt-4 text-xl font-medium">
                          Customised Solution
                        </div>
                        <p class="text-xs leading-tight text-gray-800 mb-4">
                          In the dynamic real estate industry, a one-size-fits-all approach doesn't work. Our Customised
                          Product Solutions are designed to meet your specific business needs, helping you streamline
                          operations, enhance client experience, and maximize profitability.
                        </p>
